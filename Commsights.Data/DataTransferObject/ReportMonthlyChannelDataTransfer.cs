...
{
    public class ReportMonthlyChannelDataTransfer
    {        
        ...
        public int? OnlinePercent { get; set; }
        public int? NewspaperPercent { get; set; }
        public int? TVPercent { get; set; }
        public int? MagazinePercent { get; set; }
